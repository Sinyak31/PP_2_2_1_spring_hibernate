...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        userService.add(new User("User4", "Lastname4", "user4@mail.ru", new Car("Opel", 1)));
        ...
        for (User user : users) {
            ...
            System.out.println("Car: models = " + user.getCar().getModels() + " series = " + user.getCar().getSeries());
            System.out.println();
        }
        ...
        List<User> userList = userService.getUsersByCarModel("Lada", 2);
